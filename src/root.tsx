      ...
      <body class="bg-white antialiased -mt-20">
        ...
        >
          ...
          <div class="relative md:border-x mx-auto max-w-7xl overflow-x-hidden">
            ...
            <div
              class="absolute inset-0 z-[-1] bg-gradient-to-br from-primary/20 via-primary/10 to-primary/20 dark:from-background dark:via-background/80 dark:to-background"
              aria-hidden="true"
            ></div>
